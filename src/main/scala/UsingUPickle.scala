...
object UsingUPickle extends App{
  ...
  //       !!!!! print JSON of a list of Maps with each map containing key number->value, square->value squared and
  //cube -> number cubed
  ...
  //  pw.close()
  //
  //  val fileContents = Source.fromFile("./src/resources/tod.o.json").getLines.mkString //so this leaves file open
  //  println(fileContents)
  //  val myData = read[Seq[Map[String,String]]](fileContents)
